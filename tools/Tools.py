...
class ToolManager(DbManager):
    ...
    def initGames(self):
        ...
        try:
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-ZAF-SCO', '2023/09/10 15:45:00', 'South Africa', 'RSA', 'Scotland', 'SCO');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-ZAF-ROM', '2023/09/17 13:00:00', 'South Africa', 'RSA', 'Romania', 'ROU');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-ZAF-IRL', '2023/09/23 19:00:00', 'South Africa', 'RSA', 'Ireland', 'IRL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-ZAF-TON', '2023/10/01 19:00:00', 'South Africa', 'RSA', 'Tonga', 'TON');""".format(uuid))
            uuid = str(uuid4())
