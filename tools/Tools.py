...
class ToolManager(DbManager):
    ...
    def initGames(self):
        ...
        try:
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-IRL-ROU', '2023/09/09 13:30:00', 'Ireland', 'IRL', 'Romania', 'ROU');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-JAP-CHL', '2023/09/10 11:00:00', 'Japan', 'JAP', 'Chile', 'CHL');""".format(uuid))
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-RSA-SCO', '2023/09/10 15:45:00', 'South Africa', 'RSA', 'Scotland', 'SCO');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-SAM-CHL', '2023/09/16 13:00:00', 'Samoa', 'SAM', 'Chile', 'CHL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-RSA-ROU', '2023/09/17 13:00:00', 'South Africa', 'RSA', 'Romania', 'ROU');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-ENG-CHL', '2023/09/23 15:45:00', 'England', 'ENG', 'Chile', 'CHL');""".format(uuid))
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-RSA-IRL', '2023/09/23 19:00:00', 'South Africa', 'RSA', 'Ireland', 'IRL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-ARG-CHL', '2023/09/30 13:00:00', 'Argentina', 'ARG', 'Chile', 'CHL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-SCO-ROU', '2023/09/30 19:00:00', 'Scotland', 'SCO', 'Romania', 'ROU');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-RSA-TON', '2023/10/01 19:00:00', 'South Africa', 'RSA', 'Tonga', 'TON');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool B', 'Pool B-TON-ROU', '2023/10/08 15:45:00', 'Tonga', 'TON', 'Romania', 'ROU');""".format(uuid))
            uuid = str(uuid4())
