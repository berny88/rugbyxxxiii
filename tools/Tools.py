...
class ToolManager(DbManager):
    ...
    def initGames(self):
        ...
        try:
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-SAM-CL', '2023/09/16 13:00:00', 'Samoa', 'SAM', 'Chile', 'CL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-ENG-CL', '2023/09/23 15:45:00', 'England', 'ENG', 'Chile', 'CL');""".format(uuid))
            uuid = str(uuid4())
            ...
            uuid = str(uuid4())
            c.execute("""insert into GAME (category, key, date, libteamA, teamA, libteamB, teamB) values('Pool D', 'Pool D-ARG-CL', '2023/09/30 13:00:00', 'Argentina', 'ARG', 'Chile', 'CL');""".format(uuid))
            uuid = str(uuid4())
